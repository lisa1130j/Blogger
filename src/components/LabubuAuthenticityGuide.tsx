...
export default function LabubuAuthenticityGuide({
  ...
  return (
    <section className={clsx("mx-auto max-w-5xl px-4 py-10", className)} aria-labelledby="labubu-auth-title">
...
function ChecklistCard({ title, desc, style }: { title: string; desc: string; style?: React.CSSProperties }) {
  return (
